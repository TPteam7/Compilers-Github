...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_OPEN_BRACE = 14,                /* OPEN_BRACE  */
  YYSYMBOL_CLOSE_BRACE = 15,               /* CLOSE_BRACE  */
  YYSYMBOL_CLOSE_PAREN = 16,               /* CLOSE_PAREN  */
...
{
       0,    50,    50,    62,    66,    79,    83,    87,    91,    97,
     126,   133,   137,   141,   154,   166,   179,   192,   196,   209,
     222,   226,   230,   241
};
#endif
...
static const char *const yytname[] =
{
  ...
  "PRINT", "IF", "ELSE", "WHILE", "RETURN", "SEMICOLON", "COMMA",
  "OPEN_PAREN", "OPEN_BRACE", "CLOSE_BRACE", "CLOSE_PAREN", "ASSIGN",
  "PLUS", "MINUS", "MULT", "DIV", "NUMBER", "ERROR", "$accept", "Program",
  "StmtList", "Stmt", "Declaration", "Type", "Assignment", "Print", "Expr",
...
{
       0,    11,    12,   -13,   -13,    -2,     2,    18,   -13,     0,
     -13,    29,   -13,   -13,   -13,    -1,    -1,   -13,   -13,   -13,
      22,   -13,    -1,   -13,    -4,   -12,   -13,     1,   -13,     6,
     -13,    -1,    -1,    -1,    -1,    23,   -13,   -12,   -12,   -13,
     -13,   -13
};
...
{
       0,     0,     0,    11,    12,     0,     0,     0,     2,     0,
       5,     0,     6,     7,    10,     0,     0,     8,     1,     4,
       0,    22,     0,    23,     0,    17,    20,     0,     9,     0,
      13,     0,     0,     0,     0,     0,    21,    15,    16,    18,
      19,    14
};
...
{
      -3,     1,    21,     2,     3,     4,     5,    30,    33,    34,
      27,    16,    22,    17,    31,    32,    29,    35,    18,    31,
      32,    23,    36,     6,    31,    32,    37,    38,    14,    15,
      39,    40,    20,    28,    41,    19
};

static const yytype_int8 yycheck[] =
{
       0,     1,     3,     3,     4,     5,     6,    11,    20,    21,
      16,    13,    13,    11,    18,    19,    22,    16,     0,    18,
      19,    22,    16,    23,    18,    19,    31,    32,    17,    17,
      33,    34,     3,    11,    11,     9
};
...
{
       0,     1,     3,     4,     5,     6,    23,    25,    26,    27,
      28,    29,    30,    31,    17,    17,    13,    11,     0,    26,
       3,     3,    13,    22,    32,    33,    34,    32,    11,    32,
      11,    18,    19,    20,    21,    16,    16,    33,    33,    34,
      34,    11
};
...
#line 66 "parser.y"
          ...
          stmtListNode->stmtList.stmt = (yyvsp[-1].ast);
          stmtListNode->stmtList.stmtList = (yyvsp[0].ast);
          (yyval.ast) = stmtListNode;
      }
...
#line 1208 "parser.tab.c"
  ...
  case 8: /* Stmt: ERROR SEMICOLON  */
#line 91 "parser.y"
                      { 
            fprintf(stderr, "Parser Error: Invalid statement near '%s'.\n", yytext); 
            yyerrok; 
            (yyval.ast) = NULL; // Or handle error appropriately
        }
...
#line 97 "parser.y"
        ...
        if (symbol != NULL) {    // Check if variable has already been declared
            ...
            declNode->declaration.varType = strdup((yyvsp[-2].string));
            declNode->declaration.varName = strdup((yyvsp[-1].string));
...
#line 1252 "parser.tab.c"
  ...
  case 10: /* Declaration: error ASSIGN  */
#line 126 "parser.y"
                   { 
...
#line 1280 "parser.tab.c"
  ...
  case 13: /* Assignment: ID ASSIGN Expr SEMICOLON  */
#line 141 "parser.y"
                                     { 
        ...
        assignNode->assignment.varName = strdup((yyvsp[-3].string));
        assignNode->assignment.expr = (yyvsp[-1].ast);
        (yyval.ast) = assignNode;
    }
#line 1297 "parser.tab.c"
    break;

  case 14: /* Print: PRINT OPEN_PAREN Expr CLOSE_PAREN SEMICOLON  */
#line 154 "parser.y"
                                                   { 
        printf("\nPARSER:\nPrint statement\n\n"); 
        ...
        printNode->print.expr = (yyvsp[-2].ast);
        (yyval.ast) = printNode;
    }
...
#line 166 "parser.y"
        ...
        exprNode->expr.left = (yyvsp[-2].ast);
        exprNode->expr.operator = '+';
        exprNode->expr.right = (yyvsp[0].ast);
        (yyval.ast) = exprNode;
    }
...
#line 196 "parser.y"
        ...
        termNode->term.left = (yyvsp[-2].ast);
        termNode->term.operator = '*';
        termNode->term.right = (yyvsp[0].ast);
        (yyval.ast) = termNode;
    }
...
#line 1401 "parser.tab.c"
  ...
  case 21: /* Factor: OPEN_PAREN Expr CLOSE_PAREN  */
#line 226 "parser.y"
                                    { 
        printf("\nPARSER:\nParenthesized expression\n\n"); 
        (yyval.ast) = (yyvsp[-1].ast); // The expression inside the parentheses
    }
...
#line 230 "parser.y"
        ...
        factorNode->factor.value = strdup((yyvsp[0].string));
        (yyval.ast) = factorNode;
    }
...
#line 241 "parser.y"
        ...
        factorNode->type = NodeType_Factor;
        char buffer[32];
        sprintf(buffer, "%lf", (yyvsp[0].number));
